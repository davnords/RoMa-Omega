...
def vis(img1, img2, warp_AB, warp_BA, certainty_AB, certainty_BA):
    ...
    im2_transfer_rgb = F.grid_sample(x2, warp_AB, mode="bilinear", align_corners=False)[
        0
    ]
    im1_transfer_rgb = F.grid_sample(x1, warp_BA, mode="bilinear", align_corners=False)[
        0
    ]
