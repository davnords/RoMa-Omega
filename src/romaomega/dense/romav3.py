...
from romaomega.features import Descriptor, FineFeatures
...
from romaomega.dense.matcher import Matcher
from romaomega.dense.refiner import Refiners
from romaomega.types import Setting, ImageLike, Model
...
class RoMaV3(Model):
    ...
    class Cfg:
        ...
        compile: bool = os.environ.get("COMPILE", "1") == "1"
        # name: str = "RoMa v3"
